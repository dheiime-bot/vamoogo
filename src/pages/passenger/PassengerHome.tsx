...
import { MapPin, Search, Users, Plus, Clock, ChevronRight, Car, Bike, Crown, X, Loader2, Phone, MessageCircle } from "lucide-react";
...
type RideState = "idle" | "searching" | "accepted" | "driver_arriving" | "in_progress" | "completed";
...
const PassengerHome = () => {
  ...
  const handleSearch = (query: string) => {
    if (query.length >= 2) {
      ...
      setSearchResults(getPopularLocations("Altamira", 8));
    }
  };
  ...
  const isRideActive = rideState !== "idle" && rideState !== "completed";

  return (
    <div className="min-h-screen bg-background pb-20">
      {/* Map */}
      <MapboxMap
        className="h-[35vh] rounded-none"
            ...
            <div className="space-y-3">
              ...
              {(rideState === "driver_arriving" || rideState === "in_progress") && (
                <div className="flex gap-2">
                  <button className="flex-1 flex items-center justify-center gap-2 rounded-xl border py-2.5 text-sm font-semibold">
