...
-- Adicionar campos para certidão de antecedentes criminais e verificação de liveness
ALTER TABLE public.drivers
  ADD COLUMN IF NOT EXISTS criminal_record_url text,
  ADD COLUMN IF NOT EXISTS criminal_record_issued_at date,
  ADD COLUMN IF NOT EXISTS selfie_liveness_url text,
