...
DROP TRIGGER IF EXISTS trg_notify_admins_route_change ON public.ride_route_changes;
CREATE TRIGGER trg_notify_admins_route_change
AFTER INSERT ON public.ride_route_changes
FOR EACH ROW
EXECUTE FUNCTION public.notify_admins_route_change();